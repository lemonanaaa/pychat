...
__all__ = ["open_local_endpoint", "open_remote_endpoint", "RemoteEndpoint", "LocalEndpoint"]
...
class Endpoint:
    ...
    def send(self, data: bytes, addr: SocketAddr = None):
...
async def open_datagram_endpoint(
        host, port, *, endpoint_factory, remote=False, **kwargs
):
